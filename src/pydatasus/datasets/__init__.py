"""Dataset modules for PyDataSUS subsystems.
...
- schema.py: Parquet schema definition with DuckDB types
...
from pydatasus.datasets.base import DatasetConfig, DatasetRegistry
from pydatasus.datasets.sihsus import SIHSUSConfig
from pydatasus.datasets.sim import SIMConfig
